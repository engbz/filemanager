        ...
        >
            ...
            @if(count($folder['children']) > 0)
                <button
                        ...
                        title="{{ __('filemanager::messages.expand_collapse') }}"
                >
                ...
                @if(!$isReadOnly)
                    ...
                    >
                        ...
                        <button
                                ...
                                title="{{ __('filemanager::messages.add_subfolder') }}"
                        >
                        ...
                        <button
                                ...
                                class="p-1 rounded hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
                                title="{{ __('filemanager::messages.rename') }}"
                        >
                        ...
                        <button
                                ...
                                class="p-1 rounded hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
                                title="{{ __('filemanager::messages.move') }}"
                        >
