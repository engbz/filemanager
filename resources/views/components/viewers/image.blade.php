...
>
    ...
    <div x-show="loading && !error" class="flex flex-col items-center justify-center">
        ...
        <span class="text-sm text-gray-500 dark:text-gray-400">
            {{ __('filemanager::messages.loading_preview') }}
        </span>
    </div>
    ...
    <div x-show="error" x-cloak class="flex flex-col items-center justify-center text-center p-6">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
            {{ __('filemanager::messages.image_error_details') }}
        </p>
        @if($url)
            <a
                href="{{ $url }}"
            ...
            >
                ...
                {{ __('filemanager::messages.try_download') }}
            </a>
        @endif
    </div>
    ...
    <img
        ...
        x-cloak
        src="{{ $url }}"
        alt="{{ $item?->getName() ?? __('filemanager::messages.image_preview') }}"
