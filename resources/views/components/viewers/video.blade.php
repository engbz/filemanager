...
>
    ...
    <div x-show="loading && !error" class="flex flex-col items-center justify-center text-white">
        ...
        <span class="text-sm text-gray-300">{{ __('filemanager::messages.loading_video') }}</span>
    </div>
    ...
    <div x-show="error" x-cloak class="flex flex-col items-center justify-center text-center p-6 text-white">
        ...
        <p class="font-medium">{{ __('filemanager::messages.video_unavailable') }}</p>
        <p class="text-sm text-gray-400 mt-1">
            {{ __('filemanager::messages.video_error_details') }}
        </p>
        @if($url)
            <a
                    href="{{ $url }}"
            ...
            >
                ...
                {{ __('filemanager::messages.download_video') }}
            </a>
        @endif
    </div>
    ...
    >
        ...
        {{ __('filemanager::messages.video_not_supported') }}
    </video>
</div>